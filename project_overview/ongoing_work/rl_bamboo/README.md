...
- [Real Bamboo Slips Datasets](https://1drv.ms/u/c/4851c5065d666952/EUtsyAMIqMlKpONJfRBidNsBMlkPr4eoC_SRixZ4LH9gMQ?e=ZyVVJJ) - Download this dataset and put this dataset into vit_bamboo/DATA. Test the topk results of our model:
    ```bash
    unzip DATA/SDD.zip
    sh test.sh
